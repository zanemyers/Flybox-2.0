      ...
      <div className="w-full max-w-4xl card-light">
        <div className="card-body">
          <article className="prose max-w-none">
            ...
            <p>
              Welcome to Flybox. By accessing or using this website, you agree
            ...
            <p>
              Flybox is a web-based service that collects and aggregates
              publicly available information about fly-fishing-related
              businesses and fishing reports, and summarizes them using AI.
            </p>
            ...
            <ul>
              ...
              <li>
                AI-generated summaries of fishing report content produced via
                Google Gemini.
              </li>
            </ul>

            <p className="pt-1">
              Flybox does not guarantee the accuracy, completeness, or
            ...
            <p>
              Flybox encourages users to provide their own API keys for SerpAPI
              and Google Gemini to stay in control of their usage limits and any
              associated costs. Flybox is not responsible for any charges
              incurred through your use of third-party APIs.
            </p>
            ...
            <p>
              Flybox relies on third-party data providers including SerpAPI and
              Google Gemini, as well as publicly accessible websites. We are not
              affiliated with Google, SerpAPI, or any listed businesses.
            </p>
            ...
            <p>
              Flybox is provided "as is" and "as available" without warranties
              of any kind. In no event shall Flybox be liable for any direct,
            ...
            <p>
              ...
              use of Flybox after changes are posted constitutes acceptance of
              the updated terms.
            </p>
            ...
            <p>
              ...
              <a
                ...
                href="https://github.com/zanemyers/Flybox-2.0/issues"
              >
                GitHub repository
              </a>
              .

      ...
      <div className="w-full max-w-4xl card-light">
        <div className="card-body">
          <article className="prose max-w-none">
            ...
            <p>
              Welcome to Flybox. By accessing or using this website, you agree to be bound by these Terms of Service. If you do not agree to these terms, please
              do not use the site.
            </p>
            ...
            <p>
              Flybox is a web-based service that collects and aggregates publicly available information about fly-fishing-related businesses and fishing
              reports, and summarizes them using AI.
            </p>
            ...
            <p className="pt-1">Flybox does not guarantee the accuracy, completeness, or timeliness of any information displayed.</p>

            <br />

            <h5 className="footer-title">API Keys and Third-Party Costs</h5>
            <p>
              Flybox encourages users to provide their own API keys for SerpAPI and Google Gemini to stay in control of their usage limits and any associated
              costs. Flybox is not responsible for any charges incurred through your use of third-party APIs.
            </p>
            ...
            <p>
              Flybox relies on third-party data providers including SerpAPI and Google Gemini, as well as publicly accessible websites. We are not affiliated
              with Google, SerpAPI, or any listed businesses.
            </p>

            <p className="pt-1">All trademarks, business names, and logos remain the property of their respective owners.</p>
            ...
            <p>
              Flybox is provided "as is" and "as available" without warranties of any kind. In no event shall Flybox be liable for any direct, indirect,
              incidental, or consequential damages arising from the use or inability to use the service.
            </p>
            ...
            <p>
              We reserve the right to modify these Terms of Service at any time. Changes will be effective immediately upon posting. Your continued use of
              Flybox after changes are posted constitutes acceptance of the updated terms.
            </p>

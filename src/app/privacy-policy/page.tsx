      ...
      <div className="w-full max-w-4xl card-light">
        <div className="card-body">
          <article className="prose max-w-none">
            ...
            <p>
              Flybox encourages users to provide their own third-party API keys
              (such as SerpAPI and Google Gemini) to stay in control of their
              usage limits and costs. When provided, these keys are used only to
              make requests on your behalf during your session and are never
              stored, logged, or retained by Flybox.
            </p>
            ...
            <p>
              Files generated by Flybox (such as Excel reports) are stored
              temporarily in our database solely to facilitate your download.
              They are not shared with third parties and are automatically
              removed during routine cleanup.
            </p>
            ...
            <p className="pt-1">
              ...
              third-party APIs (such as SerpAPI). Flybox does not collect
            ...
            <p>
              ...
              display information. These services may have their own privacy
              policies and terms. Flybox is not responsible for the privacy
              practices of third-party services or external websites.
            </p>
            ...
            <p>
              ...
              site functionality and analytics. You can control or disable
            ...
            <p>
              ...
              the site is accurate or up to date. Businesses are encouraged to
              verify information through their own official channels.
            </p>
            ...
            <p>
              ...
              Flybox is inaccurate or should be removed, you may contact us at
              the email below and requests will be evaluated on a case-by-case
              basis.
            </p>
            ...
            <p>
              Flybox does not knowingly collect, store, or process any personal

      ...
      <div className="w-full max-w-4xl card-light">
        <div className="card-body">
          <article className="prose max-w-none">
            ...
            <p>
              Flybox values your privacy. This Privacy Policy explains what information we collect, how we use it, and your rights regarding that information.
            </p>
            ...
            <p>
              Files generated by Flybox (such as Excel reports) are stored temporarily in our database solely to facilitate your download. They are not shared
              with third parties and are automatically removed during routine cleanup.
            </p>
            ...
            <p className="pt-1">
              This information is sourced from publicly accessible websites and third-party APIs (such as SerpAPI). Flybox does not collect private or
            ...
            <p>
              Flybox does not guarantee that business information displayed on the site is accurate or up to date. Businesses are encouraged to verify
              information through their own official channels.
            </p>
            ...
            <p>
              If you are a business owner and believe information displayed on Flybox is inaccurate or should be removed, you may contact us at the email below

...
const steps = [
    ...
    { icon: "🎣", text: <p>Optionally filter results by <strong>river name</strong> — add as many as you like</p> },
    { icon: "▶️", text: <p>Click <strong>Run Flybox</strong> — sit back while the pipeline runs</p> },
    { icon: "📥", text: <p>Your <strong>report summary</strong> and <strong>shop directory</strong> will automatically download when ready</p> },
];
    ...
    return (
        <main className="app-container">
            ...
            <div className="mt-6 flex flex-col items-center gap-1 text-xs text-base-content/70">
                <p><span className="mr-1">⚠️ <strong>Warning:</strong></span>Heavy usage may incur costs — use your own API keys to stay in control of your limits.</p>
                <p><span className="mr-1">🔒 <strong>Privacy Notice:</strong></span>Your API keys are never stored. Output files are retained temporarily to facilitate downloads.</p>
            </div>
        </main>
    );
}

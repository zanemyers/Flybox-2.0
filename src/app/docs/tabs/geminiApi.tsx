...
const geminiListItems = [
    {
        main: <p>Go to <a className="link-external" href="https://ai.google.dev/aistudio" target="_blank" rel="noopener noreferrer">ai.google.dev</a> and sign in with your Google account.</p>,
        img: gaiLogin,
        alt: "Login",
    },
    {

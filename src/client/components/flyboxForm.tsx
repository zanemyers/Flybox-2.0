...
const MapInput = dynamic(() => import("@/client/components/inputs/mapInput"), { ssr: false });
...
export default function FlyboxForm({
    ...
    return (
        <div className="app-panel flex flex-col">
            <form id="flybox-form" noValidate className="card bg-base-200 border border-base-300 shadow-sm" onSubmit={(e) => { e.preventDefault(); if (e.currentTarget.checkValidity()) handleSubmit(); else e.currentTarget.reportValidity(); }}>

...
export default function MapInput({ latitude, longitude, onChange }: {
    latitude: number;
    longitude: number;
            ...
            <dialog ref={dialogRef} className="modal" onClose={() => setShow(false)}>
                <div className="modal-box w-11/12 max-w-3xl p-0 overflow-hidden">
                    <div className="flex items-center justify-between px-6 py-4 border-b border-base-300">
                        ...
                        <button type="button" className="btn btn-sm btn-circle btn-ghost" onClick={() => setShow(false)}>✕</button>
                    </div>
                    ...
                    <MapContainer center={position} zoom={10} style={{ height: "460px", width: "100%" }} maxBounds={[[-90, -180], [90, 180]]} maxBoundsViscosity={1.0}>
                        <TileLayer
